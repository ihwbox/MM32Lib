...
*                      the "startup_MM32SPIN2xx_p.s" file.
*
...
*    Then SystemInit() function is called, in "startup_MM32SPIN2xx_p.s" file, to
...
*    the product used), refer to "HSE_VALUE" define in "MM32SPIN2xx_p.h" file. 
...
//#define SYSCLK_FREQ_XXMHz  24000000 
