...
void TIM_DeInit(TIM_TypeDef* TIMx)
{
    ...
    {       
        RCC_APB1PeriphResetCmd(RCC_APB2Periph_TIM14, ENABLE);
        RCC_APB1PeriphResetCmd(RCC_APB2Periph_TIM14, DISABLE);  
    }        
    else if (TIMx == TIM16)
    {
...
* @param  TIMx: where x can be  1, 2, 3, 8, 14, 15, 16 and 17 to select the TIM peripheral.
...
{
    /* Check the parameters */
    assert_param(IS_TIM_LIST13_PERIPH(TIMx));
...
* @param  TIMx: where x can be 1, 2, 3, 8, 6, 7, 14, 15, 16 and 17to select the TIMx
*         peripheral.
...
void TIM_BDTRConfig(TIM_TypeDef* TIMx, TIM_BDTRInitTypeDef *TIM_BDTRInitStruct)
{
	...
	assert_param(IS_TIM_DIRECT_OUTPUT_STATE(TIM_BDTRInitStruct->TIM_DirectOutput));
    /* Set the Lock level, the Break enable Bit and the Ploarity, the OSSR State,
    the OSSI State, the dead time value, the Automatic Output Enable Bit, the Direct Output Enable Bit */
...
/**
* @brief  Enables or disables the TIM peripheral Outputs.
* @param  TIMx: where x can be 1, 8, 15, 16 or 17 to select the TIMx peripheral.
* @param  NewState: new state of the TIM peripheral Direct Outputs.
*          This parameter can be: ENABLE or DISABLE.
* @retval None
*/
void TIM_IdleDirectOutputs(TIM_TypeDef* TIMx, FunctionalState NewState)
{
    /* Check the parameters */
    assert_param(IS_TIM_LIST14_PERIPH(TIMx));
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    if (NewState != DISABLE)
    {
        /* Enable the TIM Idle Direct Output */
        TIMx->BDTR |= TIM_BDTR_DOE;
    }
    else
    {
        /* Disable the TIM Idle Direct Output */
        TIMx->BDTR &= (uint32_t)(~((uint32_t)TIM_BDTR_DOE));
    }  
}
...
void TIM_OC1Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    if((TIMx == TIM1) || (TIMx == TIM16) || (TIMx == TIM17)|| (TIMx == TIM8))
    {
...
*         parameters in the TIM_OCInitStruct.
* @param  TIMx: where x can be 1, 2, 3, 8 to select the TIM peripheral.
...
void TIM_OC2Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    /* Check the parameters */
    assert_param(IS_TIM_LIST15_PERIPH(TIMx)); 
    assert_param(IS_TIM_OC_MODE(TIM_OCInitStruct->TIM_OCMode));
    assert_param(IS_TIM_OUTPUT_STATE(TIM_OCInitStruct->TIM_OutputState));
    assert_param(IS_TIM_OC_POLARITY(TIM_OCInitStruct->TIM_OCPolarity));   
...
*         parameters in the TIM_OCInitStruct.
* @param  TIMx: where x can be 1, 2, 3 or 8 to select the TIM peripheral.
...
void TIM_OC5Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    /* Check the parameters */
    assert_param(IS_TIM_LIST12_PERIPH(TIMx)); 	
    assert_param(IS_TIM_OC_MODE(TIM_OCInitStruct->TIM_OCMode));
    assert_param(IS_TIM_OUTPUT_STATE(TIM_OCInitStruct->TIM_OutputState));
    assert_param(IS_TIM_OC_POLARITY(TIM_OCInitStruct->TIM_OCPolarity));   
    ...
    /* Reset the Output Compare mode and Capture/Compare selection Bits */
    tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR3_OC5M));
  
    /* Select the Output Compare Mode */
    tmpccmrx |= (uint16_t)(TIM_OCInitStruct->TIM_OCMode << 4);	
    
    /* Reset the Output Polarity level */
    tmpccer &= (uint16_t)(~((uint16_t)TIM_CCER_CC5P));
	
    /* Set the Output Compare Polarity */
    tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OCPolarity << 16);
    
    /* Set the Output State */
    tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OutputState << 16);
    
    if((TIMx == TIM1) | (TIMx == TIM8))
    {
        assert_param(IS_TIM_OCIDLE_STATE(TIM_OCInitStruct->TIM_OCIdleState));
        /* Reset the Ouput Compare IDLE State */
        tmpcr2 &= (uint16_t)(~((uint16_t)TIM_CR2_OIS5));
        /* Set the Output Idle state */
        tmpcr2 |= (uint16_t)(TIM_OCInitStruct->TIM_OCIdleState << 8);
    }
    /* Write to TIMx CR2 */
    TIMx->CR2 = tmpcr2;
...
* @param  TIMx: where x can be 1, 2, 3, 8, 14, 15, 16 or 17 to select the TIM peripheral.
...
* @param  TIMx: where x can be 1, 2, 3 or 8 to select the TIMx peripheral
...
void TIM_OC5PreloadConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPreload)
{
    ...
    tmpccmr3 = TIMx->CCMR3;
    /* Reset the OC5PE Bit */
    tmpccmr3 &= (uint16_t)~((uint16_t)TIM_CCMR3_OC5PE);
    /* Enable or Disable the Output Compare Preload feature */
...
* @retval None
*/
void TIM_OC5FastConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCFast)
{
    uint16_t tmpccmr3 = 0;
    ...
    tmpccmr3 = TIMx->CCMR3;
    /* Reset the OC5FE Bit */
    tmpccmr3 &= (uint16_t)~((uint16_t)TIM_CCMR3_OC5FE);
    /* Enable or Disable the Output Compare Fast Bit */
...
void TIM_ClearOC5Ref(TIM_TypeDef* TIMx, uint16_t TIM_OCClear)
{
    ...
    tmpccmr3 = TIMx->CCMR3;
    /* Reset the OC5CE Bit */
    tmpccmr3 &= (uint16_t)~((uint16_t)TIM_CCMR3_OC5CE);
    /* Enable or Disable the Output Compare Clear Bit */
...
/**
* @brief  Gets the TIMx Capture Compare 5 value.
* @param  TIMx: where x can be 1 or 8 to select the TIM peripheral.
...
* @param  TIMx: where x can be 1, 2, 3, 6, 7, 8, 14, 15, 16 or 17 to select the TIMx peripheral.
...
*            @arg TIM_IT_CC5: TIM Capture Compare 5 Interrupt source
...
* @param  TIMx: where x can be 1, 2, 3, 6, 7, 8, 14, 15, 16 or 17 to select the 
*         TIM peripheral.
...
* @param  TIMx: where x can be 1, 2, 3, 6, 7, 8, 14, 15, 16 or 17 to select the TIM peripheral.
...
*            @arg TIM_IT_CC3: TIM Capture Compare 3 Interrupt source
*            @arg TIM_IT_CC4: TIM Capture Compare 4 Interrupt source
¡Á            @arg TIM_IT_CC5: TIM Capture Compare 5 Interrupt source
*            @arg TIM_IT_COM: TIM Commutation Interrupt source
*            @arg TIM_IT_Trigger: TIM Trigger Interrupt source
*            @arg TIM_IT_Break: TIM Break Interrupt source
*
...
* @param  TIMx: where x can be 1, 2, 3, 8, 15, 16 or 17  to select the TIM peripheral.
...
{
    /* Check the parameters */
    assert_param(IS_TIM_LIST16_PERIPH(TIMx));
...
* @param  TIMx: where x can be 1, 2, 3, 8 or 15 to select the TIM peripheral.
