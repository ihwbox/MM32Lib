...
* @{
*/ 
#define SYSCFG_MemoryRemap_Flash                ((uint16_t)0x00)
#define SYSCFG_MemoryRemap_SystemMemory         ((uint16_t)0x01)
#define SYSCFG_MemoryRemap_SRAM                 ((uint16_t)0x03)
...
* @{
*/ 
#define SYSCFG_CFGR1_ADC_DMA_RMP                ((uint16_t)0x100)
#define SYSCFG_CFGR1_UART1TX_DMA_RMP            ((uint16_t)0x200)
#define SYSCFG_CFGR1_UART1RX_DMA_RMP            ((uint16_t)0x400)
#define SYSCFG_CFGR1_TIM16_DMA_RMP              ((uint16_t)0x800)
#define SYSCFG_CFGR1_TIM17_DMA_RMP              ((uint16_t)0x1000)
