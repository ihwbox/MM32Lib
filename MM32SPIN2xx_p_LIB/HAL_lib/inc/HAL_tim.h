    ...
    ((*(uint32_t*)&(PERIPH)) == TIM2_BASE) || \
        ((*(uint32_t*)&(PERIPH)) == TIM3_BASE) || \
			((*(uint32_t*)&(PERIPH)) == TIM8_BASE) || \
				((*(uint32_t*)&(PERIPH)) == TIM14_BASE) || \
					((*(uint32_t*)&(PERIPH)) == TIM16_BASE) || \
						((*(uint32_t*)&(PERIPH)) == TIM17_BASE))
...
/* LIST12: TIM 1 and 8 */
#define IS_TIM_LIST12_PERIPH(PERIPH)  (((PERIPH) == TIM1) || \
((PERIPH) == TIM8))

/* LIST13: TIM 1, 2, 3, 8, 14, 15, 16 and 17 */
#define IS_TIM_LIST13_PERIPH(PERIPH) (((PERIPH) == TIM1) || \
((PERIPH) == TIM2) || \
    ((PERIPH) == TIM3) || \
		((PERIPH) == TIM8) || \
			((PERIPH) == TIM14) || \
...
/* LIST14: TIM 1, 8, 15, 16, 17 */
#define IS_TIM_LIST14_PERIPH(PERIPH) (((PERIPH) == TIM1) || \
((PERIPH) == TIM8) || \
    ((PERIPH) == TIM15) || \
		((PERIPH) == TIM16) || \
			((PERIPH) == TIM17))

/* LIST15: TIM 1, 2, 3 and 8 */
#define IS_TIM_LIST15_PERIPH(PERIPH) (((PERIPH) == TIM1) || \
((PERIPH) == TIM2) || \
    ((PERIPH) == TIM3) || \
		((PERIPH) == TIM8))
		
/* LIST16: TIM 1, 2, 3, 8, 15, 16 and 17 */
#define IS_TIM_LIST16_PERIPH(PERIPH) (((PERIPH) == TIM1) || \
((PERIPH) == TIM2) || \
    ((PERIPH) == TIM3) || \
		((PERIPH) == TIM8) || \
			((PERIPH) == TIM15) || \
...
/* Advanced-control timers (TIM1) and TIM16/17 specific features*******************/
