...
#ifdef HIGH_LOW
#define RCC_PLLMul_17                    ((uint32_t)0x003a0000)
#define RCC_PLLMul_18                    ((uint32_t)0x003d0000)
#endif
...
#define RCC_AHBPeriph_HWROOT             ((uint32_t)0x02000000)
#define RCC_AHBPeriph_HWDIV              ((uint32_t)0x04000000)
...
#define RCC_APB2Periph_CPT               ((uint32_t)0x00008000)
...
#define RCC_APB2Periph_OPAMP             ((uint32_t)0x00008000)
#define RCC_APB2Periph_ALL               ((uint32_t)0x00C7FE01)
#define IS_RCC_APB2_PERIPH(PERIPH) ((((PERIPH) & 0xFF3801FE) == 0x00) && ((PERIPH) != 0x00))
/**
* @}
*/ 
...
#define IS_RCC_APB1_PERIPH(PERIPH) ((((PERIPH) & 0xEFDDB7FC) == 0x00) && ((PERIPH) != 0x00))
/**
* @}
*/
