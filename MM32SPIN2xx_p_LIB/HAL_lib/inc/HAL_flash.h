...
* @}
*/
/** @defgroup SelectProtectRegion_x 
* @{
*/
#define SelectProtectRegion_0                 ((uint32_t)0x00000000)/*Set protect space region 0*/
#define SelectProtectRegion_1                 ((uint32_t)0x00000001)/*Set protect space region 1*/
#define SelectProtectRegion_2                 ((uint32_t)0x00000002)/*Set protect space region 2*/
#define SelectProtectRegion_3                 ((uint32_t)0x00000003)/*Set protect space region 3*/

/** @defgroup Start_x_K 
* @{
*/
#define Start_0_K                             ((uint32_t)0x00000000)/* protect space start adress from 0K*/
#define Start_2_K                             ((uint32_t)0x00000002)/* protect space start adress from 8K*/
#define Start_4_K                             ((uint32_t)0x00000004)/* protect space start adress from 8K*/
#define Start_8_K                             ((uint32_t)0x00000008)/* protect space start adress from 8K*/
#define Start_16_K                            ((uint32_t)0x00000010)/* protect space start adress from 16K*/
#define Start_32_K                            ((uint32_t)0x00000020)/* protect space start adress from 32K*/
#define Start_64_K                            ((uint32_t)0x00000040)/* protect space start adress from 64K*/
#define Start_128_K                           ((uint32_t)0x00000080)/* protect space start adress from 128K*/
#define Start_256_K                           ((uint32_t)0x00000100)/* protect space start adress from 256K*/

/** @defgroup Size_x_K 
* @{
*/
#define Size_0_K                             ((uint32_t)0x00000000)/* Size of protect space is 0K*/
#define Size_2_K                             ((uint32_t)0x00000002)/* Size of protect space is 0K*/
#define Size_4_K                             ((uint32_t)0x00000004)/* Size of protect space is 0K*/
#define Size_8_K                             ((uint32_t)0x00000008)/* Size of protect space is 8K*/
#define Size_16_K                            ((uint32_t)0x00000010)/* Size of protect space is 16K*/
#define Size_32_K                            ((uint32_t)0x00000020)/* Size of protect space is 32K*/
#define Size_64_K                            ((uint32_t)0x00000040)/* Size of protect space is 64K*/
#define Size_128_K                           ((uint32_t)0x00000080)/* Size of protect space is 128K*/
#define Size_256_K                           ((uint32_t)0x00000100)/* Size of protect space is 256K*/
#define Size_512_K                           ((uint32_t)0x00000200)/* Size of protect space is 512K*/
/**
* @}
*/
...
//FLASH_Status FLASH_EraseSecSpace(uint32_t Address);//for test
//FLASH_Status FLASH_EraseProSpace(void);//for test
//void FLASH_EraseProSpaceSramMdoe(void);//for test
//FLASH_Status FLASH_ProgramSysSecProByteData(uint32_t Address, uint16_t Data);//for test

//FLASH_Status FLASH_SysSecSetKey(u32 keyH ,u32 keyL);
//FLASH_Status FLASH_SysSecWriteGroup(uint32_t offset, u16*buf ,u16 len);
void FLASH_SysSecReadGroup(uint32_t offset, u16*buf ,u16 len);

u8 ReadByte(u32 add);
u16 ReadHalfWord(u32 add);
u32 ReadWord(u32 add);
void ReadHalfWordGroup(u16*buf,u32 add,u32 len);
//#endif /* __HAL_FLASH_H */
/**
* @}
*/
