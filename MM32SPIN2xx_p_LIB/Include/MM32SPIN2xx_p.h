...
*          definitions and memory mapping for MM32SPIN2xx_p High Density, Medium 
...
*/
#define __MPU_PRESENT             0 /*!< MM32SPIN2xx_p does not provide a MPU present or not  */
#define __NVIC_PRIO_BITS          2 /*!< MM32SPIN2xx_p uses 2 Bits for the Priority Levels    */
...
/*!< MM32SPIN2xx_p Standard Peripheral Library old types (maintained for legacy prupose) */
...
#define  RCC_APB2RSTR_CPTRST                 ((uint32_t)0x00008000)            /*!< CPT reset */
...
#define  RCC_APB2RSTR_CPTEN                  ((uint32_t)0x00008000)            /*!< CPT clock enable */
#define  RCC_APB2RSTR_TIM14EN                ((uint32_t)0x00010000)            /*!< TIM14 Timer clock enable */
#define  RCC_APB2RSTR_TIM16EN                ((uint32_t)0x00020000)            /*!< TIM16 Timer clock enable */
#define  RCC_APB2RSTR_TIM17EN                ((uint32_t)0x00040000)            /*!< TIM17 Timer clock enable */
#define  RCC_APB2RSTR_DBGMCUEN               ((uint32_t)0x00400000)            /*!< Debug MCU clock enable */
#define  RCC_APB2RSTR_PWMEN                  ((uint32_t)0x00800000)            /*!< PWM clock enable */
...
#define  ADCFG_VSEN                           ((uint32_t)0x00000008)               /*!<ADC voltage sensor enable */

#define  ADCFG_ADCPRE                         ((uint32_t)0x00004070)
...
#define  ADSTA_VALID                          ((uint32_t)0x000FFF00)               /*!<VALID[16:9] ADC channel0 valid flag*/
...
#define  ADSTA_OVERRUN                        ((uint32_t)0xFFF00000)               /*!<OVERRUN[28:20] ADC channel0 data covered flag*/
...
#define  OPAMP_CSR_OPAMP1EN                   ((uint32_t)0x00000001)
#define  OPAMP_CSR_OPAMP2EN                   ((uint32_t)0x00000100)
#define  OPAMP_CSR_OPAMP3EN                   ((uint32_t)0x00010000)
#define  OPAMP_CSR_OPAMP4EN                   ((uint32_t)0x01000000)
